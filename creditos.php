  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <?php } ?>
          <?php if ($_SESSION['nivel']==1 || $_SESSION['nivel']==0) { ?>
          <li class="active"><a href="creditos.php"><i class="fa fa-user"></i> <span>Creditos</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Usuarios
          <small>Administración de creditos a comisionistas</small>
        </h1>
      </section>
      ...
      <section class="content container-fluid">
        ...
        <!--------------------------
          ...
          <div class="panel-body table-responsive">
            <table id="listadocreditos" class="table table-striped table-bordered table-condensed table-hover">
              <thead>
                  <th>Nick</th>
                  <th>E-mail</th>
                  <th>Monto</th>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                        <form name="formulariomonto" id="formulariomonto" role="form" method="POST">
                            <div class="controls">
                                <div class="row">   
                                    <div class="col-lg-6"> 
                                        <div class="form-group">
                                            <label for="montoeditar">Asignar nuevo monto</label>
                                            <input id="montoeditar" type="text" name="montoeditar" class="form-control" placeholder="Monto" required="required"
