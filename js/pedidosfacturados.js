tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: 'controlador/pedido.php?op=listarfacturados',
					type : "get",
					dataType : "json",						
					error: function(e){
    ...
    tabla=$('#tbllistado2').dataTable(
        {
            ...
            "ajax":
                    {
                        url: 'controlador/pedido.php?op=listarfacturadosstats',
                        type : "get",
                        dataType : "json",						
                        error: function(e){
                            console.log(e.responseText);	
    ...
    function borrarpedidosfacturados() {
     $.post("controlador/pedido.php?op=borrarpedidosfacturados", function(data, status)
     {
    ...
    function pagar(idpedido) {
     $.post("controlador/pedido.php?op=ver",{idpedido : idpedido}, function(data, status){
          ...
          $("#exampleModalLabel").html('Pedido '+data.id+' total pagado $'+totalpagar.toFixed(2)); 
